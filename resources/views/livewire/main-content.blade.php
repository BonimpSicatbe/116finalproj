<div class="h-full overflow-y-auto bg-[#030712] text-white p-20">
    ...
    <div class="space-y-6 mt-11">
        <div class="container ml-5 mr-5">
            ...
            <p class="text-gray-400 mt-6 text-xl leading-relaxed ml-5 mr-20">The base URL for all API request is:</p>
            <a class="text-red-400 mt-6 text-xl leading-relaxed ml-4 mr-20 bg-gray-400 bg-opacity-20 rounded-lg p-2 transition duration-300 ease-in-out hover:bg-opacity-50" href="https://www.google.com">https://google.com</a>
        </div>
    </div>
    ...
    <div class="space-y-6 mt-11">
        <div class="container ml-5 mr-5">
            ...
            <p class="text-gray-400 text-xl leading-relaxed ml-5 mr-20"><span class="text-red-400 text-xl leading bg-gray-400 bg-opacity-20 rounded-lg inline-block p-2 transition duration-300 ease-in-out hover:bg-opacity-50">id</span> The unique identifier of the movie</p>
            <p class="text-gray-400 text-xl leading-relaxed ml-5 mr-20"><span class="text-red-400 text-xl leading bg-gray-400 bg-opacity-20 rounded-lg inline-block p-2 transition duration-300 ease-in-out hover:bg-opacity-50">id</span> The unique identifier of the movie</p>
            <p class="text-gray-400 text-xl leading-relaxed ml-5 mr-20"><span class="text-red-400 text-xl leading bg-gray-400 bg-opacity-20 rounded-lg inline-block p-2 transition duration-300 ease-in-out hover:bg-opacity-50">id</span> The unique identifier of the movie</p>
        </div>
    </div>
    ...
    <div class="space-y-6 mt-11">
        <div class="container ml-5 mr-5">
            <h2 class="text-2xl font-bold text-[#d7d7db] my-2">Base URL</h2>
            <p class="text-gray-400 mt-6 text-xl leading-relaxed ml-5 mr-20">The base URL for all API request is: </p>
            <a class="text-red-400 mt-6 text-xl leading-relaxed ml-5 mr-20 bg-gray-400 bg-opacity-20 rounded-lg p-2 transition duration-300 ease-in-out hover:bg-opacity-50" href="https://www.google.com">https://google.com</a>
        </div>
    </div>
