...
<code class="language-javascript">fetch('http://127.0.0.1:8000/api/v1/movies', {
    method: 'GET', // Specify the request method
    headers: {
        'Content-Type': 'application/json', // Specify content type
        'Authorization': 'Bearer YOUR_API_TOKEN_HERE' // Add API token if required
    }
})
    ...
    .then(data => {
        if (data.data) {
            ...
            movies.forEach(function (movie) {
                ...
                listItem.innerHTML = `${JSON.stringify(movie, null, 2)}`;
    ...
    <div id="movies-errors" class="space-y-6 mt-11">
        <div class="container ml-5 mr-5">
            ...
            <p class="text-gray-400 text-xl leading-relaxed ml-5 mb-2 mr-20"><span
                    class="text-red-400 text-xl leading bg-gray-400 bg-opacity-20 rounded-lg inline-block p-2 transition duration-300 ease-in-out hover:bg-opacity-50">401 Authentication Error
                </span> Auto-returns "Uauthenticated"</p>
            <p class="text-gray-400 text-xl leading-relaxed ml-5 mb-2 mr-20"><span
                    class="text-red-400 text-xl leading bg-gray-400 bg-opacity-20 rounded-lg inline-block p-2 transition duration-300 ease-in-out hover:bg-opacity-50">403 Authorization Error
            ...
            <p class="text-gray-400 text-xl leading-relaxed ml-5 mb-2 mr-20"><span
                ...
                <p class="text-gray-400 text-xl leading-relaxed ml-5 mb-2 mr-20"><span
                    class="text-red-400 text-xl leading bg-gray-400 bg-opacity-20 rounded-lg inline-block p-2 transition duration-300 ease-in-out hover:bg-opacity-50">500 Server Error (Exception)
    ...
    <div class="space-y-6 mt-11">
        ...
        <div
            ...
            <pre class="p-1 rounded mt-4 overflow-x-auto break-words whitespace-pre-wrap">
<code class="language-javascript">fetch('http://127.0.0.1:8000/api/v1/actors', {
    method: 'GET', // Specify the request method
    headers: {
        'Content-Type': 'application/json', // Specify content type
        'Authorization': 'Bearer YOUR_API_TOKEN_HERE' // Add API token if required
    ...
    .then(data => {
        if (data.data) {
            ...
            actors.forEach(function (actor) {
                const listItem = document.createElement('li');
                listItem.innerHTML = `${JSON.stringify(actor, null, 2)}`;
    ...
    <h1 id="directors-api" class="text-4xl font-extrabold mt-10"><span class="text-red-500 mr-2">#</span>Directors API
    </h1>
