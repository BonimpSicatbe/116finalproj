<div class="h-full overflow-y-auto bg-[#030712] text-white p-20">
    ...
    <div class="space-y-6 mt-11">
        <div class="container ml-5 mr-5">
            ...
            <p class="text-red-400 mt-6 text-xl leading-relaxed ml-5 mr-20 bg-gray-400 bg-opacity-20 rounded-lg p-2 transition duration-300 ease-in-out hover:bg-opacity-50">https://google.com</p>
            <p class="text-gray-400 mt-6 text-xl leading-relaxed ml-5 mr-20">asdasdsa</p>
        </div>
    </div>
